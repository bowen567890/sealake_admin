...
//        dd($field);
    ...
    {
        $field = $this->form->display($this->fieldData['tab'].'-'.$this->fieldData['key'], $this->fieldData['name']);
        $field = $this->rule($field, $this->fieldData['rule']);
        //        dd($field);
        return $field->help($this->fieldData['help'], $this->fieldData['help'] ? 'feather icon-help-circle' : '')->value($this->fieldData['value']);
    }
    ...
    {
        $field = $this->form->decimal($this->fieldData['tab'].'-'.$this->fieldData['key'], $this->fieldData['name']);
        $field = $this->rule($field, $this->fieldData['rule']);
