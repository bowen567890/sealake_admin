...
class PointOrderController extends AdminController
{
    ...
    {
        return Grid::make(new PointOrder(), function (Grid $grid) {
    ...
    {
        return Show::make($id, new PointOrder(), function (Show $show) {
            $show->field('id');
            $show->field('user_id');
            $show->field('point');
            $show->field('usdt_num');
    ...
    {
        return Form::make(new PointOrder(), function (Form $form) {
            $form->display('id');
            $form->text('user_id');
            $form->text('point');
            $form->text('usdt_num');
