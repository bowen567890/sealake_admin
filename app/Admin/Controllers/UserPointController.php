...
class UserPointController extends AdminController
{
    ...
    {
        return Grid::make(new UserPoint(), function (Grid $grid) {
    ...
    {
        return Show::make($id, new UserPoint(), function (Show $show) {
            $show->field('id');
            $show->field('user_id');
    ...
    {
        return Form::make(new UserPoint(), function (Form $form) {
            $form->display('id');
            $form->text('user_id');
