...
class PointOrderLogController extends AdminController
{
    /**
     * Make a grid builder.
     *
    ...
    {
        return Grid::make(new PointOrderLog(), function (Grid $grid) {
    ...
    {
        return Show::make($id, new PointOrderLog(), function (Show $show) {
            $show->field('id');
            $show->field('user_id');
            $show->field('point');
            $show->field('usdt_num');
    ...
    {
        return Form::make(new PointOrderLog(), function (Form $form) {
            $form->display('id');
            $form->text('user_id');
            $form->text('point');
            $form->text('usdt_num');
